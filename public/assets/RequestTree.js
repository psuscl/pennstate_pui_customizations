//= require RequestTreeFetch
//= require RequestTreeMarkup
...
(function (exports) {
  class RequestTree {
     ...
     * @returns {RequestTree} - RequestTree instance
     */
    constructor(
      batchSize,
      appUrlPrefix,
      ...
      this.container = document.querySelector('#request-tree-container');

      this.fetch = new RequestTreeFetch(appUrlPrefix, resourceUri);

      this.markup = new RequestTreeMarkup(resourceUri, batchSize, this.i18n);
